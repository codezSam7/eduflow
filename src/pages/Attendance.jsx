...
export default function Attendance() {
    const [selectedClass] = useState('JSS 3A - Mathematics');
            ...
            <div className="bg-white rounded-xl shadow overflow-hidden">
                <div className="p-6 border-b border-gray-200 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    ...
                    <div className="flex gap-3 w-full sm:w-auto">
                        <button className="flex-1 sm:flex-none px-4 py-2 bg-green-100 text-green-800 rounded-lg hover:bg-green-200 text-sm font-medium">
                            Mark All Present
                        </button>
                        <button className="flex-1 sm:flex-none px-4 py-2 bg-red-100 text-red-800 rounded-lg hover:bg-red-200 text-sm font-medium">
                            Mark All Absent
                        </button>
                    </div>
                </div>
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap text-right">
                                        <label className="relative inline-flex items-center cursor-pointer">
                                            ...
                                            <div className={`w-11 h-6 rounded-full peer transition-colors ${student.present ? 'bg-green-600' : 'bg-gray-300'}`}>
                                                <div className={`absolute top-0.5 left-0.5 w-5 h-5 bg-white rounded-full transition-transform ${student.present ? 'translate-x-5' : 'translate-x-0'}`}></div>
                                            </div>
                                        </label>
                                    </td>
                                </tr>
