...
export default function Assignments() {
  ...
  const [assignments] = useState([
    ...
    },
    {
      ...
      dueDate: "2026-03-28",
      description:
        "Minimum 300 words. Include introduction, body and conclusion.",
      status: "active",
      submissions: 19,
      graded: 5,
    },
    ...
    return (
      <div className="space-y-8">
        ...
        <form className="bg-white rounded-xl shadow p-8 space-y-6">
          ...
          <button
            type="button"
            className="w-full md:w-auto px-8 py-3 bg-indigo-600 text-white font-medium rounded-lg hover:bg-indigo-700"
          >
            Create Assignment
          </button>
        </form>
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">
              {selectedAssignment.className} • Due: {selectedAssignment.dueDate}
            </p>
          </div>
          <button
            onClick={() => setActiveTab("list")}
              ...
              {filteredAssignments.map((assignment) => (
                <tr key={assignment.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 text-sm">
                    {assignment.submissions} submitted • {assignment.graded}{" "}
                    graded
                  </td>
