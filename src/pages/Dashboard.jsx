        ...
        <div className="space-y-8">
            ...
            <div className="bg-white rounded-xl shadow p-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <QuickButton label="Mark Attendance" icon={Calendar} color="bg-green-100 hover:bg-green-200 text-green-800" />
                    <QuickButton label="Create Assignment" icon={BookOpen} color="bg-indigo-100 hover:bg-indigo-200 text-indigo-800" />
                    <QuickButton label="View Timetable" icon={Clock} color="bg-blue-100 hover:bg-blue-200 text-blue-800" />
                    <QuickButton label="Check Messages" icon={Users} color="bg-yellow-100 hover:bg-yellow-200 text-yellow-800" />
                </div>
            </div>
